...
shows a sequence of changes in frequency (your puzzle input). A value like +6 means the current frequency increases
...
To begin, `get your puzzle input. <https://adventofcode.com/2018/day/1/input>`_ >> `input.txt`
...
print(f"Part 2 - Answer: [{frequency}] (took {timing.time_string()})")
